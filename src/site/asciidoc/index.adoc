= ${ets-code} Conformance Test Suite
...
`org.opengis.cite.${ets-code}`. A conformance class corresponds to a &lt;test&gt; element, each
...
|Conformance Level 1
|org.opengis.cite.${ets-code}.level1.*

|Conformance Level 2
|org.opengis.cite.${ets-code}.level2.*
